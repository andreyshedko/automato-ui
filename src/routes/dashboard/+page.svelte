...
>
	...
	>
		<i class="logo-name__icon gg-arrow-left-o" id="logo-name__icon" bind:this={icon}></i>
	</div>
	<ul class="category-list">
		<div class="category-header">{@html $t('dashboard')}</div>
		<li class="category-item is-flex is-flex-direction-row is-align-items-center">
			<span>
                <i class="gg-home"></i>
            </span>
		...
		<li class="category-item is-flex is-flex-direction-row is-align-items-center">
            ...
            <span
				class="category-item-text">{@html $t('settings')}</span
		...
		<li class="category-item is-flex is-flex-direction-row is-align-items-center">
            ...
            <span
				class="category-item-text">{@html $t('account')}</span
